...
function calculateAnnualExpenses(monthlyRent, monthlyBills, weeklyFood) {
    return  ((weeklyFood * 4), monthlyBills + monthlyRent * 12)
}

//Test Cases
console.log(calculateAnnualExpenses(1400, 300, 150));  //Should log 28200

console.log(calculateAnnualExpenses(900, 400, 300));  //Should log 31200

console.log(calculateAnnualExpenses(2200, 650, 400));  //Should log 55000
